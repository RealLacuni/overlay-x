...
const SecondaryButton = (props: Props) => {
  return (
    <button
      type="button"
      className={"undraggable inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs leading-4 font-medium rounded text-indigo-700 \
...
const PrimaryButton = (props: Props) => {
  return (
    <button
      type="button"
      className={"undraggable inline-flex items-center px-2.5 py-1.5 border border-transparent text-sm font-medium rounded shadow-sm text-white \
